...
sFolder_threshold = sDistance_tolerance + '_' + sDrainage_area_threshold
...
sFolder_in = '/compyfs/liao313/04model/pyhexwatershed/global/river_network/' + sFolder_threshold
...
#for sFilename_river_network_in in aFilename:
    ...
    wkt = find_minimal_hydrobasins_watershed_boundary(sFilename_river_network_in, sFolder_watershed_boundary_in, iFlag_nested_in=True)
    #save a geojson file
