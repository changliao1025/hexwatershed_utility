...
sFilename_in = '/compyfs/liao313/00raw/hydrology/hydroshed/hydrobasin/hybas_lake_na_lev01-12_v1c/hybas_lake_na_lev06_v1c.shp'

sFilename_out = os.path.join(sWorkspace_data_out, 'na_lakes_extraction.geojson')
