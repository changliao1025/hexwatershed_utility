def convert_to_geojson(aFlowline_in, sFilename_out):
    #sFilename_filtered_hydroshed = '/compyfs/liao313/00raw/mesh/global/filtered_12p5_2p5/filtered_12p5_2p5.shp'
    #sFilename_filtered_geojson = '/compyfs/liao313/00raw/mesh/global/filtered_12p5_2p5/filter.geojson'
    #sFilename_shapefile_in = sFilename_in
    sFilename_geojson_out= sFilename_out
    ...
    pDataset_json = pDriver_json.CreateDataSource(sFilename_geojson_out)  
...
def split_filtered_hydroshed_flowline():
    ...
    aTopology_id = aTopology[*, 0]
    aTopology_downid = aTopology[*, 1]
    nFeature = len( aTopology_id )
